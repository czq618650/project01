<template>
  <div class="module-box ">
    ...
    <div style="flex:0 1 25%">
      <dv-border-box-1 style="width:100%;height:140px;">
        <dv-capsule-chart :config="config1.value" style="width:100%;height:140px" />
      </dv-border-box-1>
      <dv-border-box-2 style="width:100%;height:140px;">
        <dv-water-level-pond :config="config3" style="width:100%;height:140px" />
      </dv-border-box-2>
      <dv-border-box-10 style="width:100%;height:140px;">
        <dv-capsule-chart :config="config4.value" style="width:300px;height:140px" />
      </dv-border-box-10>
    </div>
    <!-- 中 -->
    <div style="flex:0 1 50%">
      <dv-border-box-9 style="width:100%;height:420px;">
        <!-- 地图区域 -->
        <Map></Map>
      </dv-border-box-9>
    </div>
    <!-- 右 -->
    <div style="flex:0 1 25%">
      <dv-border-box-8 style="width:100%;height:210px;">
        <dv-capsule-chart :config="config2.value" style="width:100%;height:210px" />
      </dv-border-box-8>
      <dv-border-box-10 style="width:100%;height:210px;">
        <dv-water-level-pond :config="config3" style="width:100%;height:210px" />
      </dv-border-box-10>
    </div>
  </div>
</template>
...
const getTableDate = async () => {
  ...
  config2.value = {
    data: [
      ...
      {
        name: '天津',
        value: cyCount.value[3] || 1
      },

      {
        name: '河南',
        value: cyCount.value[16] || 1
      },
      {
        name: '山东',
        value: cyCount.value[15] || 1
      }
    ],
